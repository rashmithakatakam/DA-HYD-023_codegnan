'''
control,statements --> Control of Flow of execution of a program
                   --> Conditional Statements --> if,elif,else...
                   -->Repetation statements(Loops) --> for,while (for with else)(while with else)
                   --> Jumping Statements -->break,continue,pass
'''
#Loops -->Loops aafre helpful for repetition (Automative tasks)
...
#range(start,stop,step) picks 0 as start value
#by default range 
for i in range(10):
    print(i)
...
#[] --> we generally lists
names = ['rashmitha','akshaya','srujana']
